...
document.addEventListener("DOMContentLoaded", function() {
  ...
  const mastHead = document.getElementById( 'masthead' ) || page.querySelector('header');
  ...
  const languageSwitcherButton = document.getElementById( 'pls-button-submit' );
  ...
  languageSwitcherButton.addEventListener("click", e => {
    ...
    const language_redirect_uri = languageSelect.options[languageSelect.selectedIndex].title;
